<%@ Page Language="C#" MasterPageFile="~/master.master" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="BugTracker.Main" %>
...
<div>
        <div id="sitename" style="text-align: center;">
         ...
         <div id="usermenu">             
			...
			<asp:TableRow>
				...
				<asp:HyperLink runat="server" Text="Home" NavigateUrl="Main.aspx"></asp:HyperLink> | 
				<asp:HyperLink  runat="server" Text="Forum" NavigateUrl='<%# "~/Album.aspx?id=" + Eval("Id") %>'><%# Eval("Name") %></asp:HyperLink> | 
				<asp:HyperLink runat="server" Text="Wiki" NavigateUrl='<%# "~/Album.aspx?id=" + Eval("Id") %>'><%# Eval("Name") %></asp:HyperLink> |  |
				<asp:HyperLink runat="server" Text="Register" NavigateUrl="~/Register.aspx"></asp:HyperLink> 
				</asp:TableCell>                       
             </asp:TableRow>                    
        </asp:Table>
        </div>
        ...
        <asp:Table ID="hide" CssClass="hide" runat="server">
			<asp:TableRow>
				...
				<asp:HyperLink ID="HyperLink1" runat="server" Text="Login" NavigateUrl="ChangePassword.aspx"></asp:HyperLink>
				</asp:TableCell>                 
                <asp:TableCell CssClass="login-info-right" >
                <asp:HyperLink ID="HyperLink2" runat="server" Text="Projects" NavigateUrl="Projects.aspx"></asp:HyperLink>
                </asp:TableCell>      
             </asp:TableRow>                    
        </asp:Table>
         </div>
